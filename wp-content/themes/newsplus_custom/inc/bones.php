...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', 'gp-custom' ),   // main nav in header
			'footer-links' => __( 'Footer Links', 'gp-custom' ) // secondary nav in footer
		)
	);
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu' => __( 'The Main Menu', 'gp-custom' ),  // nav name
...
function bones_footer_links() {
    ...
    wp_nav_menu(array(
    	...
    	'menu' => __( 'Footer Links', 'gp-custom' ),   // nav name
...
function bones_related_posts() {
	...
	if($tags) {
        ...
        if($related_posts) {
            ...
            <?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'gp-custom' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_query();
	echo '</ul>';
...
function bones_page_navi($before = '', $after = '') {
	...
	if ($start_page >= 2 && $pages_to_show < $max_page) {
		$first_page_text = __( "First", 'gp-custom' );
	...
	echo '</li>';
	if ($end_page < $max_page) {
		$last_page_text = __( "Last", 'gp-custom' );
